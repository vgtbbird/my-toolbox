...
//  ⚔️ 装备打造 & 熔炼查询模块 - 完整修正版
//  修正内容：
//  1. 单加/一加一减/双加 的绿字属性区分
//  2. 负面属性上限 -1
//  3. 所有数值与图表对齐（含160级）
//  4. 熔炼公式统一为 (强化最高 - 当前值) / 1.5
// ============================================================
const EquipmentQueryModule = {
    ...
    equipmentData: {
        ...
        "80": {
            ...
            "衣服": { "普通": { "防御": [136, 177] }, "强化": { "防御": [142, 185] } },
            "项链": { "普通": { "灵力": [89, 116] }, "强化": { "灵力": [93, 121] } },
            "鞋子": { "普通": { "防御": [47, 60], "敏捷": [30, 39] }, "强化": { "防御": [49, 63], "敏捷": [31, 40] } },
            "帽子": { "普通": { "防御": [47, 60], "魔法": [89, 116] }, "强化": { "防御": [49, 63], "魔法": [93, 121] } },
            "腰带": { "普通": { "防御": [47, 60], "气血": [178, 231] }, "强化": { "防御": [49, 63], "气血": [186, 242] } }
        },
        "90": {
            "武器": { "普通": { "命中": [325, 422], "伤害": [280, 364] }, "强化": { "命中": [341, 443], "伤害": [294, 382] } },
            "衣服": { "普通": { "防御": [152, 197] }, "强化": { "防御": [159, 206] } },
            "项链": { "普通": { "灵力": [99, 129] }, "强化": { "灵力": [104, 135] } },
            "鞋子": { "普通": { "防御": [52, 68], "敏捷": [33, 42] }, "强化": { "防御": [54, 71], "敏捷": [34, 44] } },
            "帽子": { "普通": { "防御": [52, 68], "魔法": [99, 129] }, "强化": { "防御": [54, 71], "魔法": [104, 135] } },
            "腰带": { "普通": { "防御": [52, 68], "气血": [199, 258] }, "强化": { "防御": [54, 71], "气血": [208, 270] } }
        },
        "100": {
            "武器": { "普通": { "命中": [355, 461], "伤害": [305, 396] }, "强化": { "命中": [372, 483], "伤害": [320, 416] } },
            "衣服": { "普通": { "防御": [168, 218] }, "强化": { "防御": [176, 228] } },
            "项链": { "普通": { "灵力": [110, 143] }, "强化": { "灵力": [115, 150] } },
            "鞋子": { "普通": { "防御": [57, 74], "敏捷": [36, 46] }, "强化": { "防御": [59, 77], "敏捷": [37, 48] } },
            "帽子": { "普通": { "防御": [57, 74], "魔法": [110, 143] }, "强化": { "防御": [59, 77], "魔法": [115, 150] } },
        ...
        "110": {
            ...
            "项链": { "普通": { "灵力": [120, 156] }, "强化": { "灵力": [126, 163] } },
            "鞋子": { "普通": { "防御": [63, 81], "敏捷": [39, 50] }, "强化": { "防御": [66, 85], "敏捷": [41, 52] } },
            "帽子": { "普通": { "防御": [63, 81], "魔法": [120, 156] }, "强化": { "防御": [66, 85], "魔法": [126, 163] } },
            "腰带": { "普通": { "防御": [60, 78], "气血": [241, 313] }, "强化": { "防御": [63, 81], "气血": [253, 328] } }
        },
        "120": {
            "武器": { "普通": { "命中": [425, 552], "伤害": [365, 474] }, "强化": { "命中": [446, 579], "伤害": [383, 497] } },
            "衣服": { "普通": { "防御": [199, 259] }, "强化": { "防御": [208, 271] } },
            "项链": { "普通": { "灵力": [131, 170] }, "强化": { "灵力": [137, 178] } },
            "鞋子": { "普通": { "防御": [68, 88], "敏捷": [43, 55] }, "强化": { "防御": [71, 92], "敏捷": [45, 57] } },
            "帽子": { "普通": { "防御": [68, 88], "魔法": [131, 170] }, "强化": { "防御": [71, 92], "魔法": [137, 178] } },
            "腰带": { "普通": { "防御": [65, 84], "气血": [262, 341] }, "强化": { "防御": [68, 88], "气血": [275, 357] } }
        },
        "130": {
            "武器": { "普通": { "命中": [465, 604], "伤害": [400, 520] }, "强化": { "命中": [488, 634], "伤害": [420, 546] } },
            "衣服": { "普通": { "防御": [215, 279] }, "强化": { "防御": [225, 292] } },
            "项链": { "普通": { "灵力": [141, 184] }, "强化": { "灵力": [148, 193] } },
            "鞋子": { "普通": { "防御": [73, 95], "敏捷": [46, 59] }, "强化": { "防御": [76, 99], "敏捷": [48, 61] } },
            "帽子": { "普通": { "防御": [73, 95], "魔法": [141, 184] }, "强化": { "防御": [76, 99], "魔法": [148, 193] } },
            "腰带": { "普通": { "防御": [70, 91], "气血": [283, 368] }, "强化": { "防御": [73, 95], "气血": [297, 386] } }
        },
        "140": {
            "武器": { "普通": { "命中": [500, 650], "伤害": [430, 559] }, "强化": { "命中": [525, 682], "伤害": [451, 586] } },
            "衣服": { "普通": { "防御": [231, 300] }, "强化": { "防御": [242, 314] } },
            "项链": { "普通": { "灵力": [152, 197] }, "强化": { "灵力": [159, 207] } },
            "鞋子": { "普通": { "防御": [78, 101], "敏捷": [49, 63] }, "强化": { "防御": [81, 105], "敏捷": [51, 66] } },
            "帽子": { "普通": { "防御": [78, 101], "魔法": [152, 197] }, "强化": { "防御": [81, 105], "魔法": [159, 207] } },
            "腰带": { "普通": { "防御": [75, 97], "气血": [304, 395] }, "强化": { "防御": [78, 101], "气血": [319, 414] } }
        },
        "150": {
            "武器": { "普通": { "命中": [540, 702], "伤害": [465, 604] }, "强化": { "命中": [567, 737], "伤害": [488, 634] } },
            "衣服": { "普通": { "防御": [246, 320] }, "强化": { "防御": [258, 335] } },
            "项链": { "普通": { "灵力": [162, 211] }, "强化": { "灵力": [170, 221] } },
            "鞋子": { "普通": { "防御": [84, 109], "敏捷": [50, 67] }, "强化": { "防御": [88, 114], "敏捷": [52, 70] } },
            "帽子": { "普通": { "防御": [84, 109], "魔法": [162, 211] }, "强化": { "防御": [88, 114], "魔法": [170, 221] } },
            "腰带": { "普通": { "防御": [80, 104], "气血": [325, 423] }, "强化": { "防御": [84, 109], "气血": [341, 443] } }
        },
        "160": {
            "武器": { "普通": { "命中": [560, 728], "伤害": [480, 624] }, "强化": { "命中": [588, 764], "伤害": [504, 655] } },
            "衣服": { "普通": { "防御": [249, 340] }, "强化": { "防御": [260, 356] } },
            "项链": { "普通": { "灵力": [163, 224] }, "强化": { "灵力": [171, 235] } },
            "鞋子": { "普通": { "防御": [84, 115], "敏捷": [52, 70] }, "强化": { "防御": [88, 120], "敏捷": [54, 73] } },
            "帽子": { "普通": { "防御": [84, 115], "魔法": [163, 224] }, "强化": { "防御": [88, 120], "魔法": [171, 235] } },
            "腰带": { "普通": { "防御": [84, 115], "气血": [329, 449] }, "强化": { "防御": [88, 120], "气血": [345, 471] } }
        }
    },
    ...
    calculateMelt() {
        ...
        if (positiveCount === 1 && !hasNegative) {
            ...
            greenType = 'plus_minus';
            greenTypeLabel = '一加一减';
        } else if (positiveCount >= 2) {
            greenType = 'double';
            greenTypeLabel = '双加';
        } else if (hasNegative && positiveCount === 0) {
            greenType = 'all_negative';
            greenTypeLabel = '全负面（异常）';
        }

        let html = `<div style="font-weight:600;color:#1f3b53;margin-bottom:8px;">📊 ${level}级 ${part} 熔炼分析</div>`;
        
        // 显示绿字类型判断
        if (greenType !== 'none' && (part === '武器' || part === '衣服')) {
            html += `<div style="background:#f0f5fb;border-radius:10px;padding:4px 12px;margin-bottom:8px;font-size:0.8rem;border:1px solid #d0dce8;">
                ...
                <span style="font-weight:700;color:${greenType === 'single' ? '#2d6b2d' : greenType === 'plus_minus' ? '#b48b3a' : '#2980b9'};">${greenTypeLabel}</span>
                ${greenType === 'plus_minus' ? `（正面: ${positiveStats.join('、')}，负面: ${negativeStats.join('、')}）` : ''}
        ...
        for (let [attr, val] of Object.entries(values)) {
            ...
            if (statAttrs.includes(attr)) {
                if (isWeaponOrCloth) {
                    ...
                    if (greenType === 'single') {
                        ...
                        maxValue = std['单加最高'];
                        gbValue = std['单加国标'];
                        limitName = `单加 (国标${gbValue}→最高${maxValue})`;
                        limitType = 'single';
                    } else if (greenType === 'plus_minus') {
                        // 一加一减
                        if (val > 0) {
                            // 正面属性
                            maxValue = std['一加一减最高'];
                            gbValue = std['一加一减国标'];
                            limitName = `一加一减(正) (国标${gbValue}→最高${maxValue})`;
                            limitType = 'plus_minus_positive';
                        } else {
                            // 负面属性：上限是 -1
                            maxValue = -1;
                            gbValue = null;
                            limitName = `一加一减(负) (最高-1)`;
                            limitType = 'plus_minus_negative';
                        }
                    } else if (greenType === 'double') {
                        // 双加
                        maxValue = std['双加单项最高'];
                        gbValue = std['双加单项国标'];
                        limitName = `双加 (国标${gbValue}→最高${maxValue})`;
                        limitType = 'double';
                    } else {
                        // 其他情况（全负面等）
                        maxValue = std['单加最高'];
                        gbValue = std['单加国标'];
                        limitName = `属性点 (国标${gbValue}→最高${maxValue})`;
                        limitType = 'single';
                    }
                } else {
                    // 非武器/衣服部位（头腰鞋等），属性点熔炼使用单加数据
                    maxValue = std['单加最高'];
                    gbValue = std['单加国标'];
                    limitName = `属性点 (国标${gbValue}→最高${maxValue})`;
                    limitType = 'single';
            ...
            // ===== 2. 衣服防御 =====
            else if (attr === '防御' && part === '衣服') {
                maxValue = std['衣服防御'][1];
                gbValue = std['衣服防御'][0];
                limitName = `衣服防御 (国标${gbValue}→最高${maxValue})`;
                limitType = 'normal';
            }
            // ===== 3. 项链灵力 =====
            else if (attr === '灵力') {
                maxValue = std['项链灵力'][1];
                gbValue = std['项链灵力'][0];
                limitName = `项链灵力 (国标${gbValue}→最高${maxValue})`;
                limitType = 'normal';
            }
            // ===== 4. 头盔魔法 =====
            else if (attr === '魔法' && part === '帽子') {
                maxValue = std['头盔魔法'][1];
                gbValue = std['头盔魔法'][0];
                limitName = `头盔魔法 (国标${gbValue}→最高${maxValue})`;
                limitType = 'normal';
            }
            // ===== 5. 腰带气血 =====
            else if (attr === '气血') {
                maxValue = std['腰带气血'][1];
                gbValue = std['腰带气血'][0];
                limitName = `腰带气血 (国标${gbValue}→最高${maxValue})`;
                limitType = 'normal';
            }
            // ===== 6. 鞋子敏捷（作为主属性） =====
            else if (attr === '敏捷' && part === '鞋子') {
                maxValue = std['鞋子敏捷'][1];
                gbValue = std['鞋子敏捷'][0];
                limitName = `鞋子敏捷 (国标${gbValue}→最高${maxValue})`;
                limitType = 'normal';
            }
            // ===== 7. 头腰鞋防御 =====
            else if (attr === '防御' && (part === '帽子' || part === '腰带' || part === '鞋子')) {
                maxValue = std['头腰鞋防御'][1];
                gbValue = std['头腰鞋防御'][0];
                limitName = `${part}防御 (国标${gbValue}→最高${maxValue})`;
                limitType = 'normal';
            }
            // ===== 8. 耐久 =====
            else if (attr === '耐久') {
            ...
            // ===== 9. 无法熔炼的属性 =====
                ...
                if (meltInfo.不可熔炼 && meltInfo.不可熔炼.includes(attr)) {
                    html += `
            ...
            if (limitType === 'plus_minus_negative') {
                // 负面属性：计算到 -1 还差多少
                const target = -1;
                canMelt = target - val;
                if (canMelt < 0) canMelt = 0;
                // 如果 val < -1，说明数据异常，但理论上不会发生
                if (val < -1) {
                    canMelt = 0;
                }
                canMelt = Math.round(canMelt * 10) / 10;
                maxFinal = val + canMelt;
                isMaxed = canMelt <= 0.1 || val <= -1;
            } else {
                // 正面属性：正常计算
                canMelt = (maxValue - val) / 1.5;
                canMelt = Math.max(0, Math.round(canMelt * 10) / 10);
                maxFinal = val + canMelt;
                isMaxed = canMelt <= 0.1;
            }
            ...
            if (isMaxed) {
                ...
                statusIcon = `可熔炼 +${canMelt.toFixed(1)}`;
                statusColor = '#2d6b2d';
            }

            const bgColor = isMaxed ? '#f5f0e8' : '#f8faff';
            const isStatAttr = statAttrs.includes(attr);

            html += `
                <div style="display:flex;justify-content:space-between;padding:4px 6px;border-bottom:1px solid #f0f4f8;border-radius:4px;${isStatAttr ? 'grid-column:1/-1;' : ''}background:${bgColor};">
        ...
        html += `
            <div style="font-size:0.7rem;color:#5a7a94;margin-top:8px;padding-top:6px;border-top:1px solid #eef2f7;">
                💡 熔炼上限 = (强化最高属性 - 当前装备初始属性) ÷ 1.5（差距±1）
                <br>💡 不管装备是不是强化打造，统一按强化打造的"最高属性"计算
                <br>💡 武器只能熔炼绿字属性，伤害和命中无法熔炼
                <br>💡 熔炼条件：装备等级 ≥ 60、当前耐久 ≥ 100
                <br>💡 <strong style="color:#b45a5a;">一加一减中的负面属性最高只能到 -1</strong>
            </div>
        `;
